                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                foreach ($classes as $classe) {
                                    $dec = explode("-", (Classe::read($classe['idClasse']))->getCodeClasse());
                                    $duree = Niveau::read((Classe::read($classe['idClasse']))->getIdNiveau())->getDuree();
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="../attestations-liste-etudiants/<?= $classe['idClasse'] ?>"><button type="button" class="btn btn-xs btn-info"><i class="fas fa-folder-open" aria-hidden="true"></i></button></a>
                                    </td>

    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                ...
                <div class="col-sm-2">
                    <a href="../etudiants"><button class="btn btn-info btn-sm btn-block" data-tog="tooltip" data-placement="left" title="Gestion des "><i class="fas fa-angle-double-left" aria-hidden="true"></i> Etudiants</button></a>
                </div>
                <div class="col-sm-2">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <table id="table_statuts" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th scope="col">N°</th>
                                    <th scope="col">Code statut</th>
                                    <th scope="col">Libellé statut</th>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $statut['codeStatut'] ?></td>
                                    <td><?php echo $statut['libelleStatut'] ?></td>
                                    <td>
                                        <a href="../View/Details/detailStatut.php?codeStatut=<?php echo $statut['codeStatut'] ?>"><button type="button" data-tog="tooltip" data-placement="bottom" title="Details" class="btn btn-xs btn-info"><i class="fas fa-folder-open" aria-hidden="true"></i></button></a>
...
<!-- ./wrapper -->
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            <div class="modal-header bg-primary">
              <h4 class="modal-title">Nouveau statut</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                <form action="../Controllers/addStatut.php" method="post" id="form">
                    <div class="modal-body mt-3">
                        <div class="form-group">
                            <label for="codeStatut">Code statut</label>
                            <input type="text" class="form-control" name="codeStatut" id="codeStatut" required>
                        </div>
                        <div class="form-group">
                            <label for="libelleStatut">Libellé statut</label>
                            <input type="text" class="form-control" name="libelleStatut" id="libelleStatut" required>
                        </div>
                    </div>
          ...
          <div class="modal-content">
            ...
            <form action="" method="post" id="form_id">
                <div class="modal-body mt-3">
                    <div class="form-group">
                        <label for="codeStatut">Code statut</label>
                        <input type="text" class="form-control" name="codeStatut" id="m_codeStatut" required>
                    </div>
                    <div class="form-group">
                        <label for="libelleStatut">Libellé statut</label>
                        <input type="text" class="form-control" name="libelleStatut" id="m_libelleStatut" required>
                    </div>
                </div>
                <div class="modal-footer justify-content-between">
    ...
    <div class="modal fade" id="deleteModal">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body mt-3">
                <div class="container">
                    <p>Voulez vous vraiment supprimer ce statut ?</p>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
                <div class="container">
    ...
    $(document).ready(function () {
        $('.updateBtn').on('click', function(){
            ...
            $('#m_codeStatut').val(data[0]);
            $('#m_libelleStatut').val(data[1]);

            document.getElementById("form_id").action = "../Controllers/updateStatut.php?codeStatut="+data[0];
    ...
    $(document).ready(function () {
        $('.deleteBtn').on('click', function(){
            ...
            document.getElementById("delete_id").href = "../Controllers/deleteStatut.php?codeStatut="+data[0];
